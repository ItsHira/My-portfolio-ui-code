...
import 'package:portfolio_app/screens/detail2.dart';
  ...
  return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        return Transform.rotate(
          angle: pi * value,
          child: carousalCard(context, listset[index]),
        );
      });
}

Widget carousalCard(BuildContext context, Modelset data) {
  return Column(
    children: <Widget>[
      Expanded(
        child: Padding(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Detail2(data: data)));
              },
              child: Container(
                decoration: BoxDecoration(
                    color: Colors.white,
